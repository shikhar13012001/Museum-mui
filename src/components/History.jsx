...
const History = (props) => {
    return (
         <Container sx={{marginTop:"10em"}}>
          ...
          <img src={props.image||"https://media.tacdn.com/media/attractions-splice-spp-674x446/07/36/8f/25.jpg"} width="100%" height="auto" alt=""/>
         </Grid>
       ...
       <p style={{fontWeight:"500",maxWidth:"80vw" }}>

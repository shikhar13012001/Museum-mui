...
const Main = () => {
 ...
 <h1 style={{transform:"rotate(270deg)",fontSize:"64px",whiteSpace:"nowrap"}} data-aos="zoom-in-up"> Louvre Meaux</h1>
       ...
       {/* <div style={{width:"100%", height:"20px",display:"flex",justifyContent:"space-between"}}> */}
        {/* </div> */}
<div data-aos="zoom-in-up" className="distortion" style={{position:'relative', width:"100%",height:"100%",maxWidth:"550px",}}>
